<template>
  <div class="FilterKeywordRelated fr_c">
    <el-popover placement="top-start" :width="400" title="相关词介绍：" trigger="hover" content="例如：搜索关键词为“电梯”，会检索出所有包含“电梯”的内容。再添加相关词“扶梯”进行检索，会检索出所有包含“电梯”或“扶梯”的内容。 选词时，请选用合理准确的行业关键词，尽量简洁。">
