<template>
  <FilterCell title="选择地区：">
    <FilterCascader ref="FilterCascader" :isMore="true" @change="searchChange" :data="AreaJsonList"></FilterCascader>
  </FilterCell>
</template>
...
import { getAreaJson } from "@/constant/areaJSON.js";
...
export default {
  ...
  computed: {
    AreaJsonList() {
      return [{ id: -1, name: "全国" }].concat(this.AreaJson);
    },
  },
  methods: {
    init(data = [-1]) {
