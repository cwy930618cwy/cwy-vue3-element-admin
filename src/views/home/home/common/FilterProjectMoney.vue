        ...
        <div class="custom fr_c">
          ...
          <div class="custom-content fr_c" v-show="currentIndex === list.length - 1">
            <div class="content-input fr_c fj_sb">
              <el-input @input="inputCustom('customBegNum', $event)" placeholder="最低" v-model="customBegNum"></el-input>
              <p style="width: 14px; height: 1px; background: rgb(204 204 204); margin: 0 6px"></p>
              <el-input placeholder="最高" @input="inputCustom('customEndNum', $event)" v-model="customEndNum"></el-input>
              <span class="content-p">万</span>
            </div>
            <div class="fs_0 custom-btn" :class="{ 'custom-btn-ch': customBegNum !== '' && customEndNum !== '' }" @click="blurCustom">
              确认
            </div>
          </div>
        </div>
